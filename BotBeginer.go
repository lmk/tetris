...
func (b *BotBigenner) findXforDown() {
	...
	for rotate := 0; rotate < 4; rotate++ {
		...
		//Debug.Println("x, y, rotate, currentX:", x, y, rotate, block.Col)
	...
	if incX == NOT_FOUND {
		...
		//Debug.Println("not found bx, cx, xBest :", bx, cx, incX)
	...
	//Debug.Println("incX, incRotate :", b.incX, b.incRotate)
}
